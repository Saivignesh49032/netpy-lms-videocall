  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-bold text-emerald-900">Meetings</h1>
          <p className="text-emerald-600">Manage and launch your live class sessions.</p>
        </div>
        {isStaffOrAbove && (
      ...
      {meetings.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 gap-4 bg-white rounded-2xl border border-dashed border-emerald-200">
          <Video className="h-12 w-12 text-emerald-300" />
          <p className="text-emerald-700 font-medium">No meetings yet.</p>
          {isStaffOrAbove && (
            <Button onClick={() => setShowForm(true)} className="bg-emerald-500 hover:bg-emerald-600 text-white gap-2">
